namespace :setup do
  ...
  task :commission, [:tenant] => 'mandala:validate_tenant' do |task, args|
    ...
    commission_rate = MasterSetup::CommissionInfo.new(start_date: Date.parse('2011-01-01'), end_date: '2016-07-23', nepse_commission_rate: 25, sebo_rate: 0.015)
    ...
    commission_rate = MasterSetup::CommissionInfo.new(start_date: Date.parse('2016-07-24'), end_date: '2021-12-31', nepse_commission_rate: 20, sebo_rate: 0.015)
    ...
    # debenture
    commission_rate = MasterSetup::CommissionInfo.new(start_date: Date.parse('2016-07-24'), end_date: '2026-12-31', nepse_commission_rate: 20, group: 1, sebo_rate: 0.015)
