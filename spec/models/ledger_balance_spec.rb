...
RSpec.describe LedgerBalance, type: :model do
  ...
  let(:ledger1){create(:ledger)}
  subject{create(:ledger_balance, ledger_id: ledger1.id)}
  ...
  describe ".update_opening_closing_balance" do
    ...
    context "when opening balance is changed" do
      ...
      context "when opening balance type is cr" do
        let(:ledger2){create(:ledger)}
        subject{create(:ledger_balance, opening_balance: 3000, ledger_id: ledger2.id)}
        it "should return closing balance" do
          subject
  ...
  describe "#update_or_create_org_balance" do
    ...
    subject(:ledger_balance){create(:ledger_balance, ledger: ledger, branch_id: nil)}
    let(:ledger_balance1){create(:ledger_balance, ledger: ledger, branch_id: 1, opening_balance: 2000)}
    let(:ledger_balance2){create(:ledger_balance, ledger: ledger, branch_id: 2, opening_balance: 1000)}
