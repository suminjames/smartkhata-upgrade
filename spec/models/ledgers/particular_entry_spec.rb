...
RSpec.describe  Ledgers::ParticularEntry do
  ...
  describe '.calculate_balances' do
    ...
    context 'when accounting date is before date' do
      ...
      context 'and debit' do
        ...
        it "adds dr_amount and increments closing balance for ledger dailies for that day" do
          # expect changes for ledger_daily_future_subject for the date
          ...
          # expect changes for ledger_daily_org_future_subject for the date
    ...
    context 'when accounting date is after date' do
      # let!(:ledger_daily_org_subject) {create(:ledger_daily, ledger: ledger, opening_balance: 7000, closing_balance: 13000, dr_amount: 6000, branch_id: nil, fy_code: 7475, date: '2017-03-08')}
      ...
      # let!(:ledger_daily_subject) {create(:ledger_daily, ledger: ledger, opening_balance: 6000, closing_balance: 11000, dr_amount: 5000, branch_id: 1, fy_code: 7475, date: '2017-03-08')}
