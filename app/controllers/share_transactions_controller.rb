class ShareTransactionsController < ApplicationController
  ...
  def securities_flow
    ...
    @download_path_xlsx = securities_flow_share_transactions_path({format:'xlsx', paginate: 'false'}.merge params.to_unsafe_h)
    @download_path_pdf = securities_flow_share_transactions_path({format:'pdf', paginate: 'false'}.merge params.to_unsafe_h)
  ...
  def sebo_report
    ...
    if @isin_infos.present?
      ...
      @download_path_xlsx = sebo_report_share_transactions_path({format:'xlsx', paginate: 'false'}.merge params.to_unsafe_h)
      @download_path_pdf = sebo_report_share_transactions_path({format:'pdf', paginate: 'false'}.merge params.to_unsafe_h)
    end
  ...
  def commission_report
    ...
    @download_path_xlsx = commission_report_share_transactions_path({format:'xlsx', paginate: 'false'}.merge params.to_unsafe_h)
    @download_path_pdf = commission_report_share_transactions_path({format:'pdf', paginate: 'false'}.merge params.to_unsafe_h)
    respond_to do |format|
      format.html
      format.js
      format.pdf do
  ...
  def threshold_transactions
    ...
    @download_path_pdf = threshold_transactions_share_transactions_path({format:'pdf', paginate: 'false'}.merge params.to_unsafe_h)
    @download_path_pdf_for_letter_head = threshold_transactions_share_transactions_path({format:'pdf', paginate: 'false', print_in_letter_head: 1}.merge params.to_unsafe_h)
  ...
  def capital_gain_report
    ...
    @download_path_xlsx = capital_gain_report_share_transactions_path({format:'xlsx'}.merge params.to_unsafe_h)
    @download_path_pdf = capital_gain_report_share_transactions_path({format:'pdf', paginate: 'false'}.merge params.to_unsafe_h)
  ...
  def contract_note_details
    ...
    @download_path_xlsx = contract_note_details_share_transactions_path({format:'xlsx'}.merge params.to_unsafe_h)
    @download_path_pdf =  contract_note_details_share_transactions_path({format:'pdf'}.merge params.to_unsafe_h)
  ...
  def closeouts
    ...
    @download_path_xlsx = closeouts_share_transactions_path({format:'xlsx', paginate: 'false'}.merge params.to_unsafe_h)
    @download_path_pdf = closeouts_share_transactions_path({format:'pdf', paginate: 'false'}.merge params.to_unsafe_h)
    respond_to do |format|
      format.html
      format.js
      format.pdf do
