  ...
  def create
    ActiveRecord::Base.transaction do
      ...
      if @esewa_payment.save
        ...
        payment_transaction = PaymentTransaction.create(payment_transaction_params.merge(payable: @esewa_payment, amount: params['total_amount'], request_sent_at: Time.now))
