...
#    for the grand total section
  ...
  $('.end').append('<td>Grand Total</td><td class="text-right">' + opening_blnc_dr + '</td><td class="text-right">' + opening_blnc_cr + '</td><td class="text-right">' + dr_amount + '</td><td class="text-right">' + cr_amount + '</td><td class="text-right">' + closing_blnc_dr + '</td><td class="text-right">' + closing_blnc_cr + '</td>')