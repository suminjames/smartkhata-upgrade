class Print::PrintSettlement< Prawn::Document
  ...
  def details_section
    ...
    text "the sum of <u><b>Rs. #{arabic_number(@settlement.amount)}</b></u>", :inline_format => true
    text "(in words) <u><b>Rs. #{arabic_word(@settlement.amount)}</b></u>", :inline_format => true
