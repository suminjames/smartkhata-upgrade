class VoucherPolicy < ApplicationPolicy
  ...
  permit_conditional_access_to_employee_and_above :new, :pending_vouchers, :convert_date

  permit_custom_access :employee_and_above, new_voucher_path(0,0), [:create, :update, :edit, :destroy]
