class ChequeEntryPolicy < ApplicationPolicy
  ...
  permit_custom_access :employee_and_above, cheque_entries_path, [:get_cheque_number, :bounce_show, :bounce_do,:represent, :update_print_status,
                                                                  :settlements_associated_with_cheque_entries,
                                                                  :bills_associated_with_cheque_entries, :make_cheque_entries_unprinted,
                                                                  :make_void
  ]
end