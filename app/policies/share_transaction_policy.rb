class ShareTransactionPolicy < ApplicationPolicy
  ...
  permit_custom_access :employee_and_above, share_transactions_path, [:new, :show, :create, :update, :edit, :destroy, :capital_gain_report, :threshold_transactions, :contract_note_details, :securities_flow, :sebo_report]
