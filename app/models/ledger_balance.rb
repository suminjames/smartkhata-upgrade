...
class LedgerBalance < ActiveRecord::Base
  ...
  def self.update_or_create_org_balance(ledger_id, fy_code, branch_id)
    ledger_balance_org = LedgerBalance.unscoped.by_fy_code(fy_code).find_or_create_by!(ledger_id: ledger_id, branch_id: branch_id)
