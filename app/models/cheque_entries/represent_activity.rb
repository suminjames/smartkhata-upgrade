class ChequeEntries::RepresentActivity < ChequeEntries::Activity
  ...
  def initialize(cheque_entry, represent_date_bs, represent_narration, current_tenant_full_name, current_user_id, selected_branch_id = nil, selected_fy_code = nil)
    super(cheque_entry, current_tenant_full_name, current_user_id, selected_branch_id, selected_fy_code)
  ...
  def perform_action
    ...
    ActiveRecord::Base.transaction do
      ...
      voucher.particulars.each do |particular|
        reverse_accounts(particular, new_voucher, description, current_user_id, 0.0, nil)
      end
