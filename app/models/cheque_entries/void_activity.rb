  ...
  def perform_action
    ...
    if is_multi_cheque_voucher
      ...
      ActiveRecord::Base.transaction do
        ...
        new_voucher = Voucher.create!(date: @cheque_entry.void_date, branch_id: @selected_branch_id, current_user_id: @current_user.id)
        ...
        process_accounts(client_ledger, new_voucher, false, @cheque_entry.amount, description, client_branch_id, Time.zone.now, @current_user)
        bank_particular = process_accounts(bank_ledger, new_voucher, true, @cheque_entry.amount, description, bank_branch_id, Time.zone.now, @current_user)
      ...
      ActiveRecord::Base.transaction do
        ...
        voucher.particulars.each do |particular|
          reverse_accounts(particular, new_voucher, description, @current_user.id)
        end
